...
/// <summary>
/// 5×5 흑/백 보드의 칸 하나. 씬에 25개 미리 배치.
/// GridBWTileChallenge가 라운드마다 Default / SafeBlack / SafeWhite 를 설정합니다.
/// </summary>
[RequireComponent(typeof(Collider))]
public class GridBWTile : MonoBehaviour
{
    ...
    public bool IsSafe => _state == TileState.SafeBlack || _state == TileState.SafeWhite;

    public void SetGridIndex(int index) => gridIndex = index;

    public bool RequiresBlack => _state == TileState.SafeBlack;
    ...
    void ApplyMaterial()
    {
        ...
        {
            TileState.SafeBlack => materialBlack,
            TileState.SafeWhite => materialWhite,
            _                   => materialDefault,
        };
    ...
    {
        Gizmos.color = IsSafe ? Color.green : Color.gray;
