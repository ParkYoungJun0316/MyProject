...
| ko | en | 비고 |
|---|---|---|
| 팀 응원 이름 | team cheer / 合言葉 / 团队口号 / grito de equipo / cri d'équipe / Teamruf / grito do time / командный клич / okrzyk drużyny | HUD 표기는 `"TEAMCHEER"` |
...
4. M.Boss는 키 없음(패널 숨김). T.Boss P4는 사탕 줄 없음.
