...
| T.Boss | ColorTile + SurviveTime + AdvancingWall/ColorWall | 보류 | ColorTile = M. 초출 시드 §4. 페이즈 초안 §6 (**P3는 2026-09-21 폐기, 판 미정**) | 응원 미정. 페이즈 자체는 확정. 조임 쓰면 T1·T3와 같은 원통 반경(축 선택 불필요) | |
...
| 3 | 75×100 | **[폐기 2026-09-21] 판 미정** — 구 내용(Sphere `AdvancingWall`+`ColorWall` + 튕김 발판)은 위 폐기 블록 참고. 전제: 원점 (0,0,0)에 **P2 ReachZone 크기(20×20)의 발판**은 항상 있어야 한다(P2 클리어 지점이 거기라서) | **조임**(2026-09-10 확정, 판이 바뀌어도 유지) |
