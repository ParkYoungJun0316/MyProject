...
| T.Boss | ColorTile = M. 초출 시드 §4. **응원 보류.** 페이즈 초안 §6 **[미잠금]** (P3 미정) |
| 조임 원상 복구 | **T1·T3만** |
...
| T.Boss | ColorTile + SurviveTime + AdvancingWall/ColorWall | 보류 | ColorTile = M. 초출 시드 §4. 페이즈 초안 §6 | 응원·P3 미정. 확정 아님 | |
...
| 3 | 75×100 | **미정** | **미정** |
| 4 | 100×100 | ColorWall **고유+흑백**, AdvancingWall | 안개 |
